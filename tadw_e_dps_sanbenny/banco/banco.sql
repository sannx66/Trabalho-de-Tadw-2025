...
VALUES
('bolo_demorango.png', 10, 'Bolo', 'Bolo sabor morango', 'Massa branca, mousse branca, morangos, creme gelado com morangos', 15.00, 'Item popular no cardápio'),
...
INSERT INTO tb_entrega (entregador, idcarrinho) 
VALUES
  ( 'Carlos Mendes', 1),
  ('Ana Pereira', 2),
  ('João Santos', 3),
